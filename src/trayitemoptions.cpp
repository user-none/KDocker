...
TrayItemOptions::TrayItemOptions() :
        ...
        m_iconifyMinimized(TrayItemOptions::TriState::Unset),
        m_iconifyObscured(TrayItemOptions::TriState::Unset),
        m_notifyTime(-1),
        m_quiet(TrayItemOptions::TriState::Unset),
        m_skipPager(TrayItemOptions::TriState::Unset),
        m_sticky(TrayItemOptions::TriState::Unset),
        m_skipTaskbar(TrayItemOptions::TriState::Unset),
        m_lockToDesktop(TrayItemOptions::TriState::Unset)
{
}
