...
=head1 DESCRIPTION
 ...
 With a few caveats. Specifically, X11 must be used and the desktop must
 have a system tray. KDocker does not work with Wayland.
...
=item B<-z>
 ...
 windows are docked. Will not attempt to launch
 or dock a window. Used to start KDocker as as
